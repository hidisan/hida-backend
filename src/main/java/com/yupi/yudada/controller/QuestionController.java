...
public class QuestionController {
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(
        ...
        // AI 生成
        String result = aiManager.doSyncAiRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userMessage, null);
        // 截取需要的 JSON 信息
    ...
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        // AI生成
        Flowable<ModelData> modelDataFlowable = aiManager.doStreamAiRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userMessage, null);
        // 括号计数器
